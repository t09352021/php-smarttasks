...
<body>
    <div class="wrapper ">
        ...
        <div class="container" id="tamanhoContainer"  >
            ...
            <form style="margin-top : 20px;" id="formtarefa2" action="_atualizar_tarefa_employee.php" method="post">
            <div class="card-header" style="margin-top:40px;background:#586F7C;color:#fff">
            <a  type="button"  href='listar_tarefa_employee.php'class="btn-close" aria-label="Close" style="position: relative; left: 98%; top:-10px; padding:10px"></a>   
                <?php
