                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="col-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form name="formprojeto" id="formprojeto" action="_inserir_projeto_employee.php" enctype='multipart/form-data' method='post'onsubmit="return validarFormulario()" >
                                    <div class="mb-3">
                                    ...
                                    <?php $codigo = rand(1111,9999); ?>
                                      <div class="mb-3">
                                          ...
                                          <input class="form-control" type="text" name="titulo_employee" required autocomplete="off">
                                          <input class="form-control" type="number" name="codigo_employee" value="<?php echo $codigo ?>"
                                          style='display: none'>
                                            
                                      </div>
                                      <div class="mb-3">
                                          <label for="formFile" class="form-label">Tipo de Projeto</label>
                                          <input class="form-control" type="text" name="tipoprojeto_employee" required autocomplete="off">
                                            
                                      </div>
                                      <div class="form-group">
                                        <div class="mb-3">
                                          <select class="form-select" required aria-label="select example" name="id_gestor_employee" id="id_gestor_employee">
                            
                                              <option selected>Selecione o gestor do projeto</option>
                                                <?php
                                                
                                                  include 'conexao.php';
                                                  $sql = "SELECT p.fk_gestor AS id_usuario, u.nome_usuario AS nome_usuario
                                                  FROM projetos p
                                                  INNER JOIN tarefas t ON p.id_projeto = t.id_projt
                                                  INNER JOIN usuarios u ON u.id_usuario = p.fk_gestor
                                                  WHERE u.nivel_usuario = '2'
                                              ...
                                              ?> 
                                                <option value="<?php echo $nome_usuario?>">
                                        ...
                                        <input type="hidden" class="form-control" name="id_gestor_employee" id="id_gestor_employee" value="<?php echo $id_usuario?>"> 
                                        <div class="mb-3">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Descrição do Projeto</label>
                                            <textarea class="form-control" name="descricao_projeto_employee" rows="4"></textarea>
                                        </div>
                                    </div>                                     
                                    <div class="mb-3">
