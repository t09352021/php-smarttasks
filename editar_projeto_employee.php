...
<body>
    <div class="wrapper ">
        ...
        <div class="container" id="tamanhoContainer"  >
            ...
            <form style="margin-top : 20px;" action="_atualizar_projeto_employee.php" method="post" id="formconsproj">
            <div class="card-header" style="margin-top:40px;background:#586F7C;color:#fff">
            <a  type="button"  href='listar_projeto_employee.php'class="btn-close" aria-label="Close" style="position: relative; left: 98%; top:-10px; padding:10px"></a>   
                <?php
                $sql = "SELECT p.*, u.nome_usuario AS gestor, p.fk_gestor AS id_gestor
                FROM projetos p
