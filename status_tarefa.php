...
<main class="content">
                ...
                $usuario = $_SESSION['usuario'];
                            ...
                            FROM usuarios
                            WHERE email_usuario = '$usuario' AND status = 'Ativo' ";
                ...
                $sql_statustarefa = "SELECT t.*, p.titulo, u.nome_usuario AS gestor, s.status_tarefa, s.id_statustarefa, t.fk_statustarefa
                FROM tarefas t
                ...
                while ($dados = mysqli_fetch_array($busca_statustarefa)) {
                            ...
                            $id_status = $dados['fk_statustarefa'];                            
