  ...
  <div class="main">
    ...
    ?>
                        ...
                        <tbody>                                   
                           <?php
                             include 'conexao.php';
                              ...
                              $sql = "SELECT t.*, p.titulo AS projeto 
                              FROM tarefas t
      ...
      <?php
        ...
        ?>
        <a href="editar_tarefa_employee.php?id=<?php echo $id_tarefa?>" role="button"><i class="bi bi-pencil-square"></i>&nbsp;</a>
        <a href="deletar_tarefa_employee.php?id=<?php echo $id_tarefa?>" onclick="return confirm('Tem certeza que deseja deletar este registro ?')" role="button"><i class="far fa-trash-alt"></i>&nbsp;</a></td>
