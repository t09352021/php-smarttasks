                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="col-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form name="formtarefa" id="formtarefa" action="_inserir_tarefa.php" enctype='multipart/form-data' method='post' onsubmit="return validarFormulario()" >
                                    <div class="mb-3">
                                    <label>Projeto</label>
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="projeto" id="projeto" required>
                                        ...
                                        <option selected>Selecione</option>
                                            <?php
                                                ...
                                                $sql = "SELECT id_projeto, titulo, datain, dataout 
                                                        FROM projetos 
                                                        ORDER BY titulo ASC";
