...
<nav id="sidebar" class="sidebar js-sidebar " >
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand" href="painelEmployee.php">
				<h4>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="painelEmployee.php">
					...
					<li class="sidebar-item" id="add-projt">
						<a class="sidebar-link" href="cadastro_projeto_employee.php">
					...
					<li class="sidebar-item" id="cons-projt">
						<a class="sidebar-link toggle" href="listar_projeto_employee.php">
					...
					<li class="sidebar-item" id="add-tarefa">
						<a class="sidebar-link" href="cadastro_tarefa_employee.php">
					...
					<li class="sidebar-item" id="cons-tarefa">
						<a class="sidebar-link" href="listar_tarefa_employee.php">
					...
					<li class="sidebar-item" id="estima-tarefa">
						<a class="sidebar-link" href="calc&projeto_employee.php">
							<i class="align-middle" data-feather="search"></i><span class="align-middle">Estimativa</span>
						</a>
					</li>
					<li class="sidebar-item" id="status-tarefa">
						<a class="sidebar-link" href="status_tarefa_employee.php">
							<i class="align-middle" data-feather="search"></i><span class="align-middle">Status Tarefa</span>
						</a>
					</li>
					<li class="sidebar-item">
